...
Tab:Toggle("Tương tác Rooms","Sets the Enabled property of all Proximity Prompts to true. Useful for getting to the Rooms without a Skeleton Key.",false,function(Bool)
...
if Floor.Value == "Hotel" or Floor.Value == "Fools" then
    Tab:Button("Giải Khu Thư Viện [Đủ 5 Cuốn Sách Đúng Để Giải]","Chạm Để Giải Nhưng Đủ 5 Cuốn Đúng Và Cần 1 Tờ Giấy Để Giải.",function()
...
Tab2:Toggle(" Không Sao Chép Thư Rác","Other players will basically see you having a seizure.",false,function(Bool)
    if Bool then
